...
function getInitialFrogDiaryCluePhase({
  ...
  if (initialSceneJumpStepId === "flyer-miss-loop" && stage.id === "street-flyer") {
    return { kind: "flyer-miss-loop" };
  }
...
export function FrogDiaryClueEventModal({
  ...
  if (phase.kind === "flyer-miss-loop") {
    return <FlyerMissReactionLoopPreview locale={locale} />;
  }
