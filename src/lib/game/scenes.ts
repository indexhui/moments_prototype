...
export const GAME_SCENES: Record<string, GameScene> = {
  ...
  "scene-91": {
    ...
    characterName: "小麥",
    dialogue:
      "這隻被我吐槽後畫的黃金獵犬，我也記得。小白還幫牠取了名字，叫直太郎⋯⋯\n她最愛畫一些有的沒的小動物了⋯⋯",
    showDialogAvatar: true,
...
export const AFTER_REWARD_SCENE_ID = "scene-night-hub";
