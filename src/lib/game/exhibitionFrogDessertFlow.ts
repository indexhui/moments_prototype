...
import { DESSERT_FROG_TARGET_RECT, DESSERT_SHOP_BACKGROUND } from "@/lib/game/frogDessertReveal";
...
export const EXHIBITION_DESSERT_FROG_STAGE: FrogDiaryClueStage = {
  ...
  sceneImage: DESSERT_SHOP_BACKGROUND,
  photoSceneImage: DESSERT_SHOP_BACKGROUND,
  photoOverlayPreset: "dessert-cabinet",
  frogTargetRect: DESSERT_FROG_TARGET_RECT,
  frogRevealLineIndex: 6,
  containerSearch: {
    afterLineIndex: 5,
  },
  lines: [
