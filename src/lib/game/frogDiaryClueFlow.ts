...
export const FROG_DIARY_CLUE_STAGES: readonly FrogDiaryClueStage[] = [
  ...
  },
  {
    ...
    lines: [
      { speaker: "旁白", text: "小麥走在街道上，手裡的傳單被風吹得翻飛。" },
      { speaker: "旁白", text: "一陣風突然捲過來，傳單整疊飛了出去。" },
      { speaker: "小麥", text: "啊！糟糕，全部散掉了！" },
      { speaker: "旁白", text: "她追著紙張跑，聽見其中一張傳單後方傳來呱呱聲。" },
      { speaker: "小麥", text: "這個聲音……又是青蛙？" },
