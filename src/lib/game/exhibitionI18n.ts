...
export const EXHIBITION_FROG_DIARY_TEXT = {
  zh: {
    title: "搬家",
    openingText: "今天是和小麥正式成為室友的日子！\n我們約了搬家公司，只是在門口等搬家公司來的時候，街道忽然傳來一陣騷動……",
    revealText: "原來是鄰居家小孩玩球時，不小心撞上了發傳單的人，傳單飛得到處都是！\n反正搬家公司也還沒來，我就和小麥一起幫忙把四散的傳單撿回來，算是做了一樁好事呢(´ω` )",
    firstPuzzlePromptText: "今天是和小麥正式成為室友的日子！\n我們約了搬家公司，只是在門口等搬家公司來的時候，＿＿忽然傳來一陣騷動……",
    firstPuzzleText: "今天是和小麥正式成為室友的日子！\n我們約了搬家公司，只是在門口等搬家公司來的時候，街道忽然傳來一陣騷動……",
    secondPuzzlePromptText: "傳單撿好後沒多久，搬家公司也來了！天氣很熱、東西又很多，搬到超級累的（「°Д°）「，後來在休息時，我看到櫃子上有幾瓶＿＿＿＿的飲料……",
    secondOpeningText: "傳單撿好後沒多久，搬家公司也來了！天氣很熱、東西又很多，搬到超級累的（「°Д°）「，後來在休息時，我看到櫃子上有幾瓶便利商店的飲料……",
    secondRevealText: "我想，那些飲料應該是小麥買回來的吧？\n真的是太貼心了！因為口實在太渴，忍不住直接開了幾瓶，咕嚕咕嚕地一口氣乾",
    thirdPuzzlePromptText: "沒想到搬家到一半時，我才知道……那些飲料居然是搬家工人買來要自己喝的!!!! (;´༎ຶД༎ຶ`) 我真的是!!!丟臉到爆炸!!!! 後來出去領要給搬家費用的錢，經過我最愛的＿＿＿時……",
    thirdPuzzleText: "沒想到搬家到一半時，我才知道……那些飲料居然是搬家工人買來要自己喝的!!!! (;´༎ຶД༎ຶ`) 我真的是!!!丟臉到爆炸!!!! 後來出去領要給搬家費用的錢，經過我最愛的甜點店時……",
    thirdOpeningText: "沒想到搬家到一半時，我才知道……那些飲料居然是搬家工人買來要自己喝的!!!! (;´༎ຶД༎ຶ`) 我真的是!!!丟臉到爆炸!!!! 後來出去領要給搬家費用的錢，經過我最愛的甜點店時……",
    thirdRevealText: "小麥提議，可以買一些小點心回去賠罪，所以我們就買了幾個蛋糕回去請搬家工人吃，幸好他們人很好，沒有計較我喝了他們的飲料！下次真的不可以再這麼丟臉了（「´д`）",
