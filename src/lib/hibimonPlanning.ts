    ...
    stages: [
      {
        ...
        diaryTarget: {
          ...
          unrestoredFrogFragmentPhotoAttemptCount: 0,
        },
      },
      {
        id: "frog-shop-event",
      ...
      {
        id: "frog-dessert-shop",
        mainFunction: "甜點店路線與最終線索",
        condition: "下班後陪同事尋找甜點店",
        locationRequirement: "甜點店",
        plot: "同事買生日蛋糕時忘記男友年齡，蛋糕紙袋裡鑽出青蛙",
        diary: "回到家有飲料，就喝了",
        level: "甜點店轉彎路徑拼圖",
        playUnit: { type: "story-route", mode: "frog-clue" },
        diaryTarget: {
