...
編劇版本目前已落到「隔天選擇街道、第一次遇到青蛙、完成街道日記後前往公司、完成上班遊戲、發現忘帶便當、安排便利商店路線、在超商與店員對話、第二次拍照、完成便利商店日記、返回公司繼續工作」。`dessert-transition`、`frog-dessert`、`home-final`、`complete` 等 phase 仍可作為原型骨架，但其後續文案尚未全部重新由編劇確認。
