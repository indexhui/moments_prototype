# Moment game SFX selection

Only sounds that are currently connected to gameplay are kept in this folder.
The three original Kenney packs remain untouched elsewhere.
...
| `card-duel-reveal.ogg` | Casino Audio 1.1 | `card-fan-1.ogg` | Reveal both battle cards |
